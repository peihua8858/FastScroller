...
public class ScrollbarView extends View {
    private static final IOldScrollBind mScrollBind;
    ...
    static {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            mScrollBind = new OldScrollBindApi23Impl();
        } else {
            mScrollBind = new OldScrollBindBaseImpl();
        }
    }
    ...
    public ScrollbarView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ScrollbarView, defStyleAttr, R.style.WidgetScrollbarView);
        this.mScaledTouchSlop = viewConfiguration.getScaledTouchSlop();
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_minThumbLength, 48);
        this.mMinThumbLength = dimensionPixelSize;
        this.mOverScrollMinThumbLength = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_overScrollMinThumbLength, dimensionPixelSize);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_minThumbWidth, 16);
        int dimensionPixelSize3 = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_thumbWidth, dimensionPixelSize2);
        this.mThumbWidth = dimensionPixelSize3;
        if (dimensionPixelSize3 < dimensionPixelSize2) {
            this.mThumbWidth = dimensionPixelSize2;
        }
        this.mTrackWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_trackWidth, this.mThumbWidth);
        this.mThumbTouchHotWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ScrollbarView_thumbTouchHotWidth, 16);
        this.mScrollThumbTint = obtainStyledAttributes.getColor(R.styleable.ScrollbarView_scrollThumbTint, ViewCompat.MEASURED_SIZE_MASK);
        this.mScrollTrackTint = obtainStyledAttributes.getColor(R.styleable.ScrollbarView_scrollTrackTint, ViewCompat.MEASURED_SIZE_MASK);
        Drawable drawable = obtainStyledAttributes.getDrawable(R.styleable.ScrollbarView_scrollThumb);
        ...
        setTrackDrawable(obtainStyledAttributes.getDrawable(R.styleable.ScrollbarView_scrollTrack));
        this.mThumbType = obtainStyledAttributes.getInt(R.styleable.ScrollbarView_thumbType, 0);
        this.mStartAngle = obtainStyledAttributes.getFloat(R.styleable.ScrollbarView_startAngle, 35.0f);
        this.mSweepAngle = obtainStyledAttributes.getFloat(R.styleable.ScrollbarView_sweepAngle, 110.0f);
        this.mVibrateDelayTime = obtainStyledAttributes.getInteger(R.styleable.ScrollbarView_vibrateDelayTime, 0);
    ...
    public static IOldScrollBind getScrollBindImpl() {
        return mScrollBind;
    }
