...
public class OldScrollbarHelper {
    ...
    public static class AbsListViewFastScrollListener implements ScrollbarView.OnFastScrollListener {
        ...
        public void onScroll(int scrollX, int scrollY, float scrollProgress) {
            OldScrollbarHelper.onScroll(this.absListView, scrollX, scrollY, scrollProgress);
        }
    }
    ...
    public static class OnFastScrollListenerImpl implements ScrollbarView.OnFastScrollListener {
        ...
        @Override
        public void onScroll(int scrollX, int scrollY, float scrollProgress) {
            int measuredHeight = OldScrollbarHelper.getMeasuredHeight(this.recyclerView);
            int abs = Math.abs(scrollY);
            RecyclerView recyclerView = this.recyclerView;
            if (abs < measuredHeight) {
                recyclerView.scrollBy(scrollX, scrollY);
            } else {
                OldScrollbarHelper.onScroll(recyclerView, scrollX, scrollY, scrollProgress);
            }
        }
    }
    ...
    public static void bindScrollableView(View view, ScrollbarView scrollbarView) {
        ...
        if (view instanceof AbsListView) {
            OldScrollbarHelper.bindListView((AbsListView) view, scrollbarView);
        } else if (view instanceof RecyclerView) {
            OldScrollbarHelper.bindRecyclerView((RecyclerView) view, scrollbarView);
        } else if (view instanceof ScrollView) {
            OldScrollbarHelper.bindScrollView((ScrollView) view, scrollbarView);
        }  else if (view instanceof NestedScrollView) {
            OldScrollbarHelper.bindNestedScrollView((NestedScrollView) view, scrollbarView);
        }else {
...
//        b(scrollView, scrollbarView);
    ...
    public static void onScrollableViewTouchEvent(View view, ScrollbarView scrollbarView, MotionEvent motionEvent) {
        Objects.requireNonNull((NewScrollBindBaseImpl) ScrollbarView.getScrollBindImpl());
