...
//        stateListDrawable.addState(new int[]{-android.R.attr.state_selected}, layerDrawable2);
        ...
        val drawable = GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, intArrayOf(pressedColor))
        drawable.cornerRadius = radius
        stateListDrawable.addState(intArrayOf(android.R.attr.state_selected), drawable)
        stateListDrawable.addState(StateSet.NOTHING, ColorDrawable(normalColor))
