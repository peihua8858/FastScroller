...
public class ScrollbarView extends View {
    ...
    private static final IScrollBind scrollBindImpl;
    ...
    static {
        if (VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            scrollBindImpl = new ScrollBindApi23Impl();
        } else {
            scrollBindImpl = new ScrollBindBaseImpl();
        }
    }
    ...
    private static Context wrapContext(Context context, int defStyleAttr) {
        return WidgetCompat.wrapContext(context, defStyleAttr, R.style.ThemeScrollbarView);
    }

    private void initAttrs(Context context, AttributeSet attributeSet, int var3) {
        ViewConfiguration configuration = ViewConfiguration.get(context);
        TypedArray array = context.obtainStyledAttributes(attributeSet, R.styleable.ScrollbarView, var3, R.style.WidgetScrollbarView);
        this.mScaledTouchSlop = configuration.getScaledTouchSlop();
        this.mScrollThumb = array.getDrawable(R.styleable.ScrollbarView_scrollThumb);
        this.mScrollTrack = array.getDrawable(R.styleable.ScrollbarView_scrollTrack);
        this.mMinThumbHeight = array.getDimensionPixelSize(R.styleable.ScrollbarView_minThumbHeight, 48);
        this.mMinThumbWidth = array.getDimensionPixelSize(R.styleable.ScrollbarView_minThumbWidth, 16);
        this.mScrollThumbTint = array.getColor(R.styleable.ScrollbarView_scrollThumbTint, 16777215);
        this.mScrollTrackTint = array.getColor(R.styleable.ScrollbarView_scrollTrackTint, 16777215);
    ...
    public void setScrollableView(View view, boolean flag) {
        if (view == null) {
            Log.w("ScrollbarView", "setScrollableView: view is null");
